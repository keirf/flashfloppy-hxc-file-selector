...
struct amiga_custom {
    ...
    cust_ptr_t bpl1pt;  /*  e0 */
    cust_ptr_t bpl2pt;
    cust_ptr_t bpl3pt;
    cust_ptr_t bpl4pt;
    cust_ptr_t bpl5pt;  /*  f0 */
    cust_ptr_t bpl6pt;
    cust_ptr_t bpl7pt;
    cust_ptr_t bpl8pt;
    uint16_t bplcon[4]; /* 100 */
    uint16_t bpl1mod;
    uint16_t bpl2mod;
    uint16_t bplcon4;
    uint16_t clxcon2;
    uint16_t bpl1dat;   /* 110 */
    uint16_t bpl2dat;
    uint16_t bpl3dat;
    uint16_t bpl4dat;
    uint16_t bpl5dat;
